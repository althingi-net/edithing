...
class DocumentController {
    ...
    /**
     * Returns a list of all documents stored in a xml file on github.
     */
    @Get('/document')
    ...
    /**
     * Returns a document from the database if it exists, otherwise it downloads it from github and saves it to the database.
