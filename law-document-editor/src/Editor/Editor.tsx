...
export const Editor: FC<Props> = (props) => {
    ...
    const { handleChange, handleSave, handlePublish } = useEditorNavigationBlock(editor, navigationBlocker, saveDocument, publishBill);
        ...
        <Slate editor={editor} initialValue={slate} onChange={handleChange}>
            <div style={{ height: 'calc(100vh - 104px)' }}>
                <Row gutter={16} style={{ height: '100%' }}>
                    ...
                    <Col span={12}>
                        { readOnly ? null : <Toolbar saveDocument={handleSave} publishBill={handlePublish} bill={bill} t={t} navigationBlocker={navigationBlocker} /> }
                        <EditorSidePanel
                            t={t}
                            readOnly={readOnly}
                            xml={xml}
