...
import { isListItem, ListItem } from '../../slate/element/ListItem';
import { MetaType } from '../Slate';
import { createLawTitle } from '../slate/createLawTitle';
import { createList } from '../slate/createList';
import { createListItem } from '../slate/createListItem';
import { createListItemMeta } from '../slate/createListItemMeta';
import { createListItemMetaFromSibling } from '../slate/createListItemMetaFromSibling';
import { getListItemTitle } from '../slate/getListItemTitle';
import { incrementFollowingSiblings } from '../slate/incrementFollowingSiblings';
...
export const createLawList = (editor: Editor, type: MetaType, path: Path, options: CreateLawListOptions = {}) => {
